    ...
    return (
        <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 pt-20 pb-30">
            <div className="flex flex-col justify-center items-center text-center">
                <h1 className="text-4xl md:text-[40px] font-bold text-purple-900">Customer Testimonials</h1>
                ...
                {testimonials.map((testimonial) => (
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            />
                            <div>
                                <p className="font-playfair text-xl text-purple-600">{testimonial.name}</p>
